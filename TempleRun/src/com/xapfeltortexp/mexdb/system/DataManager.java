package com.xapfeltortexp.mexdb.system;
...
import com.xapfeltortexp.mexdb.exception.EmptyListException;
import com.xapfeltortexp.mexdb.exception.NoSuchIndexException;
import com.xapfeltortexp.mexdb.file.IOManager;
...
public class DataManager{
    ...
    /**
     * Updates a list from an entry or adds it if the key is nonexistent
     * without updating the flatfile.<br>
     * <b>Make sure that no String in the list contains the coding "%&"</b>,<br> since that is
     * the coding for concatenating the Strings in the entry.
    ...
    /**
     * Made for the value getters, as soon as a key was found
     * on the args-string, the linkedhashmap is returned.
     */
